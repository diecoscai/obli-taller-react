    ...
    const fetchData = async () => {
      try {
        ...
        if (people.length > 0) {
          ...
          const montevideoPeople = people.filter(
            (person) => person.departamento === montevideoDeptId
          );
        ...
        <Card
          ...
          <CardContent>
            ...
            <Typography
              variant="h4"
              component="p"
              sx={{ color: 'white', fontSize: '2.5rem', marginTop: '10px' }}>
              {totalCensados}
            </Typography>
          </CardContent>
        </Card>
        ...
        <Card
          ...
          <CardContent>
            <Typography
              ...
              component="h2"
              sx={{ color: 'white', fontWeight: 'bold', fontSize: '1rem' }}>
              Personas censadas por usuario sobre total censados
            </Typography>
            <Typography
              variant="h4"
              component="p"
