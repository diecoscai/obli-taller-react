    ...
    if (name !== '' || depto !== '' || city !== '' || birthday !== '' || occupation !== '') {
      ...
      fetchAddPerson(newPerson)
        .then((response) => {
          ...
          // Reset showSuccessAlert after a delay (e.g., 3000 milliseconds)
          setTimeout(() => {
    ...
    <>
      <div>
        ...
        <Grid
          ...
          {showSuccessAlert && <CustomAlert message="Person added successfully!" color="success" />}{' '}
          <form>
            <Grid
              maxWidth={1000}
              margin="auto"
